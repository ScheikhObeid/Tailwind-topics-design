...
$yourProjectDirectory = $_SESSION['project_path'];
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <link href="<?php echo $yourProjectDirectory ."/public/css/style.css"?>" rel="stylesheet" />
  ...
  <body>
      ...
      <img
        src=  "<?php echo $yourProjectDirectory . "/public/img/profile.jpg"?>"
