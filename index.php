...
<?php
 ...
 // include $_SESSION['pro_inc_path'] . "/views/partials/author_sidebar.php";
  // include $_SESSION['pro_inc_path'] . "/views/partials/show.php";
?>
<?php
...
<!--  npx tailwindcss -i ./src/css/input.css -o ./public/css/style.css --watch
      "./*.php", "./public/views/*.php", "./public/views/partials/*.php"  
-->
  ...
  <div class="dropdown relative">
    <a class="dropdown-toggle flex items-center hidden-arrow" href="#" id="dropdownMenuButton2" role="button"
      ...
      <img src="<?php echo $_SESSION['project_path'] . "/public/img/profile.jpg"?>" class="rounded-full"
